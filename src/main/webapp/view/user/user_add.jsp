...
<form action="${pageContext.request.contextPath}/user/add.do" class="form-horizontal" method="post">
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="login_account" class="form-control input-sm" />
                </div>
            </div>
        </div>
        <div class="col-sm-5">
    ...
    <div class="row">
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="wx_account" class="form-control input-sm" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="id_no" class="form-control input-sm" />
                </div>
            </div>
        </div>
        <div class="col-sm-5">
