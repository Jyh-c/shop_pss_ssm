        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $.each(dataArr, function (i) {
                    ...
                    htmlData = htmlData + "<td>"+ dataArr[i].barCode +"</td>";
                    htmlData = htmlData + "<td>"+ dataArr[i].category.categoryName +"</td>";
                    htmlData = htmlData + "<td>"+ dataArr[i].productName +"</td>";
                    htmlData = htmlData + "<td>"+ dataArr[i].salePrice +"</td>";
                    htmlData = htmlData + "<td>"+ dataArr[i].supplier.supplierName +"</td>";
                    htmlData = htmlData + "<td><a href=\"/product/find-id.do?id="+dataArr[i].id+"\">修改</a>|<a href=\"/product/delete.do?id="+dataArr[i].id+"\">删除</a></td>";
                    htmlData = htmlData + "</tr>";
                });
                list = data.data;
                createPageNav({
